...
| `src/GraphView.tsx`, `src/GraphEdge.tsx`, `src/GraphConnectionDetails.tsx`, `src/graph/` | Dense argument maps, full-screen layout, connection inspection, and shared connector geometry |
