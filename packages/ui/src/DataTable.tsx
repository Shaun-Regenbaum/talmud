...
export interface DataTableProps<T> {
  ...
  labels: { empty: string; showLess: string; showMore: (count: number) => string };
}
  ...
  return (
    <div class="ui-data-table">
          ...
          <tr>
            <For each={props.columns}>
              {(col) => (
                ...
                >
                  <Show when={col.sortValue} fallback={col.header}>
                    <button type="button" class="ui-table-sort" onClick={() => toggleSort(col)}>
                      {col.header}
          ...
          <Show
            ...
            fallback={
              <tr>
                ...
                >
                  {props.emptyText ?? props.labels.empty}
                </td>
              </tr>
            }
          >
      ...
      <Show when={props.maxRows && hiddenCount() > 0}>
        ...
        >
          {expanded() ? props.labels.showLess : props.labels.showMore(hiddenCount())}
        </button>
      </Show>
    </div>
  );
