...
export const GEOGRAPHY_SYSTEM = [
  ...
  '- Do NOT include people, tribes, or peoples — only physical places. A',
  '  gentilic (Jebusites, Amorites, Canaanites, Philistines) names a PEOPLE,',
  '  not a place: leave it out, even where the chapter is listing territory.',
  '  A personal name that is spelled like a place (Havilah and Sheba as sons',
  '  of Joktan in Genesis 10, Cush as a son of Ham) is a person there and does',
  '  not belong on the map either — include a name only where the verse is',
