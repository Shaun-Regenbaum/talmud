...
const segInstances = (fields: z.ZodRawShape, extra: z.ZodRawShape = {}) =>
  z.object({
    ...extra,
    instances: z.array(
      z.object({ startSegIdx: seg(), endSegIdx: seg(), fields: z.object(fields) }),
    ),
  });
...
// Marks
// ===========================================================================
export const RABBI_OUTPUT_SCHEMA = responseFormat(
  'rabbi_marks',
  markInstances({ name: z.string(), nameHe: z.string(), generation: z.enum(GEN) }),
);

export const PLACES_OUTPUT_SCHEMA = responseFormat(
  'places_marks',
  markInstances({
    name: z.string(),
    nameHe: z.string(),
...
export const HALACHA_OUTPUT_SCHEMA = responseFormat(
  'halacha_topics',
  segInstances({
    topic: z.string(),
    topicHe: z.string(),
...
export const CHART_OUTPUT_SCHEMA = responseFormat(
  'chart_tables',
  segInstances({
    caption: z.string(),
    captionHe: z.string(),
...
export const AGGADATA_OUTPUT_SCHEMA = responseFormat(
  'aggadata_stories',
  segInstances({
    title: z.string(),
    titleHe: z.string(),
...
export const YERUSHALMI_OUTPUT_SCHEMA = responseFormat(
  'yerushalmi_parallels',
  segInstances({
...
export const PESUKIM_OUTPUT_SCHEMA = responseFormat(
  'pesukim_refs',
  segInstances({
    verseRef: z.string(),
...
export const ARGUMENT_OUTPUT_SCHEMA = responseFormat(
  'argument_sections',
  segInstances(
    {
      title: z.string(),
      ...
      excerpt: z.string(),
      endExcerpt: z.string(),
      rabbiNames: z.array(z.string()),
    },
    { summary: z.string() },
  ),
);

export const ARGUMENT_MOVE_OUTPUT_SCHEMA = responseFormat(
  'argument_moves',
  segInstances({
    id: z.string(),
    sectionStartSegIdx: seg(),
    sectionEndSegIdx: seg(),
    moveOrder: seg(),
    role: z.enum([
      'opening',
      'question',
...
// ===========================================================================
export const ARGUMENT_VOICES_OUTPUT_SCHEMA = responseFormat(
  'argument_voices',
  z.object({
    voices: z.array(
      z.object({
...
export const ARGUMENT_OVERVIEW_FLOW_OUTPUT_SCHEMA = responseFormat(
  'argument_overview_flow',
  z.object({
    connections: z.array(
      z.object({
        from: z.number().int(),
...
export const DAF_BACKGROUND_CONCEPTS_OUTPUT_SCHEMA = responseFormat(
  'daf_background_concepts',
  z.object({
    groups: z.array(
      z.object({
...
export const TIDBIT_ESSAY_OUTPUT_SCHEMA = responseFormat(
  'tidbit_essay',
  z.object({
...
export const BIYUN_ESSAY_OUTPUT_SCHEMA = responseFormat(
  'biyun_essay',
  z.object({
    hook: z.string(),
    paragraphs: z.array(z.string()),
...
export const ARGUMENT_NARRATIVE_OUTPUT_SCHEMA = responseFormat(
  'argument_narrative',
  z.object({
    summary: z.string(),
    actors: z.array(
...
export const ARGUMENT_BRIDGE_OUTPUT_SCHEMA = responseFormat(
  'argument_bridge',
  z.object({
    continues: z.boolean(),
    note: z.string(),
...
export const ARGUMENT_BACKGROUND_OUTPUT_SCHEMA = responseFormat(
  'argument_background',
  single('background'),
);
export const ARGUMENT_SYNTHESIS_OUTPUT_SCHEMA = responseFormat(
  'argument_synthesis',
  single('synthesis'),
);
...
// ===========================================================================
export const ARGUMENT_MOVE_COMMENTARIES_OUTPUT_SCHEMA = responseFormat(
  'argument_move_commentaries',
  z.object({ rashi: z.string(), tosafot: z.string(), other: z.string(), note: z.string() }),
);
export const ARGUMENT_MOVE_SYNTHESIS_OUTPUT_SCHEMA = responseFormat(
  'argument_move_synthesis',
  single('synthesis'),
);
export const ARGUMENT_MOVE_SUGGESTED_QUESTIONS_OUTPUT_SCHEMA = responseFormat(
  'argument_move_suggested_questions',
  SUGGESTED_QUESTIONS,
);
...
export const PLACE_SIGNIFICANCE_OUTPUT_SCHEMA = responseFormat(
  'place_significance',
  single('significance'),
);
export const PLACE_FIGURES_OUTPUT_SCHEMA = responseFormat('place_figures', single('figures'));
export const PLACES_SYNTHESIS_OUTPUT_SCHEMA = responseFormat(
  'places_synthesis',
  single('synthesis'),
);
...
// Rishonim
// ===========================================================================
export const RISHONIM_SYNTHESIS_OUTPUT_SCHEMA = responseFormat(
  'rishonim_synthesis',
  single('synthesis'),
);
...
export const HALACHA_CODIFICATION_OUTPUT_SCHEMA = responseFormat(
  'halacha_codification',
  z.object({
...
export const HALACHA_DISPUTE_OUTPUT_SCHEMA = responseFormat(
  'halacha_dispute',
  z.object({
    present: z.boolean(),
...
// Pesukim enrichments
// ===========================================================================
export const PESUKIM_TANACH_CONTEXT_OUTPUT_SCHEMA = responseFormat(
  'pesukim_tanach_context',
  single('context'),
);
export const PESUKIM_WHY_HERE_OUTPUT_SCHEMA = responseFormat(
  'pesukim_why_here',
  single('why_here'),
);
export const PESUKIM_MECHANISM_OUTPUT_SCHEMA = responseFormat(
  'pesukim_mechanism',
  single('mechanism'),
);
export const PESUKIM_LANDING_OUTPUT_SCHEMA = responseFormat('pesukim_landing', single('landing'));
export const PESUKIM_SYNTHESIS_OUTPUT_SCHEMA = responseFormat(
  'pesukim_synthesis',
  single('synthesis'),
);
export const PESUKIM_SUGGESTED_QUESTIONS_OUTPUT_SCHEMA = responseFormat(
  'pesukim_suggested_questions',
  SUGGESTED_QUESTIONS,
);
...
// ===========================================================================
export const AGGADATA_BACKGROUND_OUTPUT_SCHEMA = responseFormat(
  'aggadata_background',
  single('background'),
);
export const AGGADATA_INTERPRETATION_OUTPUT_SCHEMA = responseFormat(
  'aggadata_interpretation',
  single('interpretation'),
);
export const AGGADATA_PARALLELS_OUTPUT_SCHEMA = responseFormat(
  'aggadata_parallels',
  z.object({
    parallels: z.array(
      z.object({
...
export const AGGADATA_SYNTHESIS_OUTPUT_SCHEMA = responseFormat(
  'aggadata_synthesis',
  single('synthesis'),
);
export const AGGADATA_SUGGESTED_QUESTIONS_OUTPUT_SCHEMA = responseFormat(
  'aggadata_suggested_questions',
  SUGGESTED_QUESTIONS,
);
...
export const RABBI_RELATIONSHIPS_EVIDENCE_OUTPUT_SCHEMA = responseFormat(
  'rabbi_relationships_evidence',
  z.object({
    evidence: z.array(
      z.object({
...
export const RABBI_GEOGRAPHY_EVIDENCE_OUTPUT_SCHEMA = responseFormat(
  'rabbi_geography_evidence',
  z.object({
    evidence: z.array(
      z.object({
...
export const RABBI_LOCATION_OUTPUT_SCHEMA = responseFormat(
  'rabbi_location',
  z.object({
    place: z.string(),
    region: region4,
...
export const RABBI_PHILOSOPHY_OUTPUT_SCHEMA = responseFormat(
  'rabbi_philosophy',
  single('philosophy'),
);
export const RABBI_RELATIONSHIPS_OUTPUT_SCHEMA = responseFormat(
  'rabbi_relationships',
  z.object({
...
export const RABBI_CLASSIFICATION_OUTPUT_SCHEMA = responseFormat(
  'rabbi_classification',
  z.object({
    category: z.enum(['aggadist', 'halachist', 'exegetist']),
    justification: z.string(),
  }),
);
...
// ===========================================================================
export const ENRICH_JSON_SCHEMA = responseFormat(
  'rabbi_enrichment',
  z.object({
...
export const TRANSLATE_BIO_JSON_SCHEMA = responseFormat(
  'wiki_bio_translation',
  z.object({
