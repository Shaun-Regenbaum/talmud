...
const CATALOG = {
  ...
  'usage.cost.remaining.sub': { en: '{count} amudim to go', he: '{count} עמודים נותרו' },
  ...
  'usage.cost.warmed': { en: 'Shas warmed', he: 'ש״ס שחומם' },
  'usage.cost.warmed.sub': { en: '{warmed} / {total} amudim', he: '{warmed} / {total} עמודים' },
