    ...
    <Show when={visible()}>
      <div
        style={{
          ...
          margin: '0 0 0.6rem', padding: '8px 12px',
          border: '1px solid var(--line)', 'border-radius': '8px',
          background: '#faf6f3',
        }}
      >
        <span style={{ flex: '1 1 auto', 'font-size': '13px', color: 'var(--fg)', 'min-width': '0' }}>
        ...
        <button
          ...
          style={{ height: 'auto', padding: '6px 12px', 'font-size': '13px', 'border-radius': '6px' }}
        >
