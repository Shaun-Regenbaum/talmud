...
export const fixtures: Fixture[] = [
  // === Common shapes (stairs, double-extend) ===
  {
    id: 'berakhot-2a',
    label: 'Berakhot 2a',
    hint: 'Double-Wrap · big first word',
    tractate: 'Berakhot',
    page: '2a',
    amud: 'a',
    hebrewBooksUrl: hb(1, '2'),
...

  {
    id: 'ketubot-2a',
    label: 'Ketubot 2a',
    hint: 'Double-Wrap · long Tosafot',
    tractate: 'Ketubot',
    page: '2a',
    amud: 'a',
    hebrewBooksUrl: hb(15, '2'),
...

  {
    id: 'sanhedrin-2a',
    label: 'Sanhedrin 2a',
    hint: 'Stairs · long Rashi',
    tractate: 'Sanhedrin',
    page: '2a',
    amud: 'a',
    hebrewBooksUrl: hb(24, '2'),
  ...
  // === Extreme Double-Wrap ===
  {
    id: 'shabbat-2a',
    label: 'Shabbat 2a',
    hint: 'Extreme Double-Wrap · tiny main, huge Tosafot',
    tractate: 'Shabbat',
    page: '2a',
    amud: 'a',
    hebrewBooksUrl: hb(2, '2'),
  ...
  // === Edge cases: short commentary triggering exception ===
  {
    id: 'yevamot-2a',
    label: 'Yevamot 2a',
    hint: 'Exception=1 candidate · Rashi only 178 chars',
    tractate: 'Yevamot',
    page: '2a',
    amud: 'a',
    hebrewBooksUrl: hb(14, '2'),
...

  {
    id: 'berakhot-55a',
    label: 'Berakhot 55a',
    hint: 'Exception=2 candidate · Tosafot only 184 chars',
    tractate: 'Berakhot',
    page: '55a',
    amud: 'a',
    hebrewBooksUrl: hb(1, '109'),
...

  {
    id: 'eruvin-2b',
    label: 'Eruvin 2b',
    hint: 'Double-exception · both short (Rashi 75, Tosafot 199)',
    tractate: 'Eruvin',
    page: '2b',
    amud: 'b',
    hebrewBooksUrl: hb(3, '2b'),
